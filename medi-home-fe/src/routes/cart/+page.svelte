...
<div class="mx-auto max-w-5xl px-4 py-8">
		...
		<table class="min-w-full divide-y divide-gray-200 bg-white">
			<thead class="bg-gray-50 text-gray-700">
				<tr>
					...
					<th class="px-4 py-3 text-sm font-medium">Giá</th>
					...
					<tr class="transition hover:bg-gray-50">
						...
						<td class="px-4 py-3 text-center">
							<select
								...
								class="rounded border border-gray-300 bg-gray-50 px-2 py-1 text-sm focus:ring-1 focus:ring-blue-400 focus:outline-none"
							>
	...
	<div class="mt-6 flex justify-end text-lg font-semibold text-gray-800">
		Tổng cộng: <span class="ml-2 text-blue-600">{cart.totalamount} VND</span>
	</div>
</div>
<!-- 
<section>
	<div class="mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
		<div class="mx-auto max-w-3xl">
			...
			<div class="mt-8">
				<ul class="space-y-4">
					<li class="flex items-center gap-4"></li>
